            ...
            <div class="col col-8">
               <div class="card m-3 p-3">
                <h1 class="row justify-content-center">Change Password</h1>
                    <form onsubmit="return submitForm()" action="{{route('chenged')}}" method="post">
                    @csrf
                        <div class="mb-3">
                           <label for="exampleInputEmail1" class="form-label">Old Password<span class="text-danger">*</span> : </label>
                           <div class="d-flex form-control">
                           <i class="bi bi-lock-fill fs-5"></i>
                               <input type="password" class="form-control border-0 outlin-none validation" name="oldpass" aria-describedby="emailHelp">
                            </div>
                        </div>
