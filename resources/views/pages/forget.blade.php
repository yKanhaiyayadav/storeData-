            ...
            <div class="col col-8">
               <div class="card m-3 p-3">
                <h1 class="row justify-content-center">Forget Password</h1>
                    <form onsubmit="return submitForm()" action="{{route('forgetpass')}}" method="post">
                    @csrf
                        <div class="mb-3">
                           <label for="exampleInputEmail1" class="form-label">Full Name<span class="text-danger">*</span> : </label>
                               <input type="text" class="form-control validation" name="name" aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                           ...
                           <input type="number" class="form-control validation" name="mobile">
                        </div>
                        <div class="errorCheck"></div>
